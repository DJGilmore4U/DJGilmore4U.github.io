...
const ProfileText = ({ status }) => (
  <React.Fragment>
    ...
    <ProfileDescription status={status}>
      In my spare time I like to cook and create new software or web applications. I’m always down for collaborating on new projects, so feel free to drop me a line.
    </ProfileDescription>
  </React.Fragment>
);
