...
const SparrowLink = 'https://radiant-spire-24907.herokuapp.com/';
...
const ProfileText = ({ status }) => (
  <React.Fragment>
    ...
    <ProfileDescription status={status}>
      I’m DJ, currently I live in San Diego. I have worked the last 13 years as a telecommunications engineer and now recently graduated the UCSD Full Stack Development Program. <Anchor href={SparrowLink} target="_blank" rel="noopener noreferrer">KinderCash</Anchor>
    </ProfileDescription>
    <ProfileDescription status={status}>
      In my spare time I like to cook, create new software, and <Anchor href={ModLink} target="_blank" rel="noopener noreferrer">make mods</Anchor>. I’m always down for hearing about new projects, so feel free to drop me a line.
    </ProfileDescription>
  </React.Fragment>
);
