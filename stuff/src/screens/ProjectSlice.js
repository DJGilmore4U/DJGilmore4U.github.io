...
const description = 'These projects are workings from the UCSD Full Stack Development Program with a few little side projects of my own.';
const roles = [
  'UI Design',
  'UX Design',
  'Database Design',
  ...
  <React.Fragment>
    ...
    <ProjectContainer>
      ...
      <ProjectHeader
        ...
        url="https://github.com/DJGilmore4U"
        roles={roles}
      />
      <ProjectSection>
        <ProjectSectionContent>
          <ProjectImage entered={!prerender}>
            <ProgressiveImage
              ...
              alt="An archive of dev projects."
      ...
      <ProjectSection>
        <ProjectSectionColumns>
          <SidebarImagesText>
            <ProjectSectionHeading>Development Projects</ProjectSectionHeading>
            <ProjectSectionText>
              Here is a compiled list of projects that I have been working on lately.
            </ProjectSectionText>
            <ProjectSectionText>
            </ProjectSectionText>
          </SidebarImagesText>
